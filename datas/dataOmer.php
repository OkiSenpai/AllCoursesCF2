...
$decription = [
    "titre" => "Bienvenue",
    "description" => "Bienvenue sur mon mini site en php où vous pouvez voir tous ce qu'on a fait en cours de programmation just'à maintentant, cliquer sur le cours qui vous interes pour voir le contenu de chaque cours. n'hesitez pas de ajouter des truc et de metre à jour le site"
];
...
$contenu = [
    ...
    "Pourquoi ce projet est important"=> [
        "Répétition et mémorisation : En ajoutant régulièrement du contenu, je peux mieux retenir ce que j'apprends.",
        "Portfolio personnel : Ce site peut servir de vitrine pour montrer mes compétences et projets futurs.",
        "Approche pratique : En appliquant directement ce que j'apprends, je comprends mieux les concepts théoriques.",
        "Archivage structuré : Chaque cours est séparé par technologie pour une navigation facile.",
    ],
];